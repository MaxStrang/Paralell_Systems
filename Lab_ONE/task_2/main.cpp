...
int main(int argc, char *argv[])
{
	...
	t = clock() - t;
	std::cout << "The enclosing ball is " << b << "; elapsed time=" << 1000.0 * t / CLOCKS_PER_SEC << "ms" << std::endl;
	t = clock();
	int i = m.farthest(b.center);
	t = clock() - t;
	std::cout << "The farthest point from the ball center is #" << i << "; elapsed time=" << 1000.0 * t / CLOCKS_PER_SEC << "ms" << std::endl;
	return 0;
}
